...
function AppointmentHistory() {
    ...
    function getAppointment(page, type = null) {
        ...
        setLoading(true)
        var url = `admin/center/appointments?type=history&from_date=${search.from_date}&to_date=${search.to_date}&center_id=${search.center_id}`
        if(search.appointment_status !== 'all') {
            url += `&appointment_status=${search.appointment_status}`
        }

        if (type == 'reset') {
            var url = `admin/center/appointments?type=history&limit=10&page=${page}`
        }
        ...
        <Layout>
            ...
            <div className="main-panel">
                <div className="content-wrapper">
                                ...
                                <div className="col-xl-12">
                                    <nav aria-label="breadcrumb">
                                        <ol className="breadcrumb">
                                            ...
                                            <li className="breadcrumb-item active" aria-current="page">Appointment History</li>
                                        </ol>
                                    </nav>
                    ...
                    <Filters search={search} setSearch={setSearch} filterData={filterData} type="history"/>
