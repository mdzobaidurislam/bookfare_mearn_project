...
router.post(
  "/partner",
  validation.patnerForm,
  partnerController.AdminaddPartner
);
...
router.post(
  "/center-image",
  upload.single("image"),
  centersController.centerImageUpload
);
router.post(
  "/patients",
...
router.get(
  "/center/appointment/:id",
  book_appointmentController.bookAppointmentList
);

//
router.post(
  "/center-document-category",
  validation.centerDocumentCategory,
  centersController.centerDocumentCategory
);
router.get(
  "/center-document-category",
  centersController.centerDocumentCategoryList
);
router.get(
  "/center-document-category-details/:id",
  centersController.centerDocumentCategoryDetails
);
router.delete(
  "/center-document-category/:id",
  centersController.centerDocumentCategoryDelete
);
router.put(
  "/center-document-category/:id",
  validation.centerDocumentCategory,
  centersController.centerDocumentCategoryupdate
);
router.get(
  "/center/appointments",
  book_appointmentController.adminBookAppointmentList
);

//center slots routes
router.get(
  "/appointment/slot-details/:center_id/:day",
...
router.put(
  "/notification-read",
  notificationController.getAdminNotificationsRead
);

//-----------------------------------------------------------end enquiry-------------------------------------------------------

router.get(
  "/appointment/date-slots/:centerId",
...
router.delete(
  "/appointment/date-slot/delete/:delete", // delete
  appointmentSlotController.appointmentDateSlotsDelete
);

router.put(
  "/appointment/date-slot/update/:update",
  // validation.appointmentDateSlotUpdate, // create// update
...
router.post(
  "/upload-gallery/:centerId",
  validation.uploadGallery,
  GalleryController.updateImages
); //imageId
router.delete(
  "/upload-gallery/:centerId/:imageId",
  GalleryController.deleteImage
);
router.post(
  "/make-primary-gallery/:centerId",
  GalleryController.updatePrimaryImages
); //imageId
...
router.put(
  "/center-enquiry/:id",
  centerEnquiryController.adminUpdateStatusEnquiry
);
//-----------------------------------end center enquiry------------------------
// 1263
