...
router.post(
  "/center-enquiry",
  validation.centerEnquiryValidation,
  centerEnquiryController.centerEnquiryAdd
);
...
router.post(
  "/reports",
  jwtToken,
  validation.patientsReports,
  patientsReportsController.addReports
);
...
router.post(
  "/share-reports",
  jwtToken,
  patientsReportsController.shareMultipleReport
);
router.post(
  "/appointment/upload-documents",
  jwtToken,
  patientsReportsController.appoitmentUploadDocument
);
router.post(
  "/appointment-attachment/:appointment_id",
  jwtToken,
  patientsReportsController.appoitmentAttachments
);
...
router.post(
  "/add-family",
  jwtToken,
  validation.patientfamilyMamber,
  patientsController.patientFamilyMamber
);
router.put(
  "/edit-family/:id",
  jwtToken,
  validation.patientfamilyMamber,
  patientsController.patientUpdateFamilyMamber
);
...
router.post(
  ...
  patientsController.SendRegisterOTP
);
router.post(
  "/register",
  validation.RegisterPatients,
  patientsController.newPatients
);
router.get(
  "/family-member-list",
  jwtToken,
  patientsController.patientFamilyMamberList
);
router.post("/book-appointment", jwtToken, patientsController.bookAppointment);
router.get(
  "/list-appointment",
  jwtToken,
  patientsController.bookAppointmentList
);
router.get(
  "/appointment/:appointmentId",
  jwtToken,
  patientsController.getAppointment
);
...
router.get(
  "/check-center-feedback",
  jwtToken,
  ratingController.checkCenterFeedback
);
router.get(
  "/check-testimonial",
  jwtToken,
  testimonialController.checkTestimonial
);
...
router.post(
  ...
  jwtToken,
  patientsController.rescheduleAppointment
);
