...
function ReviewModal(props) {
  ...
  function reviewFormHandler() {
    axiosBaseUrl
      .post(`patients/api/review`, reviewData)
      .then((res) => {
        // alert("estt")
        console.log(res);
        if (res.status === 200) {
          ...
          <div className="row">
            ...
            <div className="col-md-12">
              ...
              <div className="form-group center-rating">
                <ul>
                  {Array(5)
                    .fill()
                    .map((_, i) => {
                      return reviewData.cleanliness_rating >= i + 1 ? (
                        <li>
                          <i
                            ...
                            value={i}
                            onClick={(e) =>
                              handleRating("cleanliness_rating", i + 1)
                            }
                          ></i>
                        </li>
                      ) : (
              ...
              <span className="text-danger">
                {reviewErrors.cleanliness_rating}
              </span>
            </div>
              ...
              <div className="form-group center-rating">
                <ul>
                  {Array(5)
                    .fill()
                    .map((_, i) => {
                      return reviewData.service_rating >= i + 1 ? (
                        <li>
                          <i
                            className="fa fa-star"
                            name="cleanliness_rating"
                            value={i}
                            onClick={(e) =>
                              handleRating("service_rating", i + 1)
                            }
                          ></i>
                        </li>
                      ) : (
              ...
              <div className="form-group center-rating">
                <ul>
                  {Array(5)
                    .fill()
                    .map((_, i) => {
                      return reviewData.hygiene_rating >= i + 1 ? (
                        <li>
                          <i
                            className="fa fa-star"
                            name="cleanliness_rating"
                            value={i}
                            onClick={(e) =>
                              handleRating("hygiene_rating", i + 1)
                            }
                          ></i>
                        </li>
                      ) : (
