...
function RegisterOTPValidationNumber(values) {
  let errors = {};
  console.log("values", values);
  if (!values.otp) {
    errors.dataOtp = "OTP is required";
  } else if (!values.otp.trim()) {
    errors.dataOtp = "OTP is not space";
  }
...
export { RegisterOTPValidation, RegisterOTPValidationNumber };
