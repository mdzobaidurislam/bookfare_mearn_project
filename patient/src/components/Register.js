...
} from "../Validation/RegisterValdation";
...
function Register() {
  ...
  function handle(e) {
    ...
    if (e.target.name === "phone") {
      if (
        e.target.value === "" ||
        (/^[0-9\b]+$/.test(e.target.value) && e.target.value.length <= 10)
      ) {
  ...
  const signUpOTPHandler = (e, type) => {
    ...
    if (Object.keys(error_data).length === 0) {
      setData("");
      axiosBaseUrl
        .post("patients/api/register-otp", data)
        .then((res) => {
          setErrors({});
          if (res.status === 200) {
  ...
  const signUpHandler = (e) => {
    ...
    if (Object.keys(error_data).length === 0) {
      console.log("yes");
      axiosBaseUrl
        .post("patients/api/register", data)
        .then((res) => {
          setErrors({});
          if (res.status === 200) {
            setLoaderState(false);
  ...
  return (
    <Layout>
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-6 offset-lg-3">
              <form
                className="php-email-form register-card"
              ...
              >
                <div className="row">
                  ...
                  <div className="col-md-6 mb-3">
                    <div
                      className={
                        data.gender == "male" ? "gender-k" : "gender-g"
                      }
                    >
                      <button
                        className="btn btn-g"
                  ...
                  <div className="col-md-6 mb-3">
                    <div
                      className={
                        data.gender == "female" ? "gender-k" : "gender-g"
                      }
                    >
                      <button
                        className="btn btn-g"
                  ...
                  <div className="col-md-12 mt-1">
                    <div className="form-group">
                      ...
                      <span className="ml-1">
                        ...
                        <strong>
                          <Link to="/term-&-user" target="blank">
                            Terms of Service
                          </Link>
                        </strong>
                        ,{" "}
      ...
      <Modal show={showModal} onHide={() => setShowModal(false)}>
        ...
        <form id="Login" onSubmit={(e) => signUpOTPHandler(e, "resend")}>
          <Modal.Body>
            ...
            <div className="text-right mt-2">
              <button
                ...
                onClick={(e) => signUpOTPHandler(e, "resend")}
              >
                Resend OTP
              </button>
            </div>
